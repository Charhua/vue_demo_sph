            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder(1)">
                  <a href="#">综合<span v-show="isOne"class="iconfont" :class="{'icon-ascending':isAsc,'icon-descending':isDesc}"></span></a>
                </li>
                <li :class="{active:isTwo}"@click="changeOrder(2)">
                  <a href="#">价格<span v-show="isTwo"class="iconfont" :class="{'icon-ascending':isAsc,'icon-descending':isDesc}"></span></a>
                </li>
              </ul>
            </div>
          </div>
...
<!--                    详情页路由跳转-->
                  ...
                  <div class="price">
                    <strong>
                      <em>¥</em>
                      <i>{{goodItem.price}}.00</i>
                    </strong>
                  </div>
                  <div class="attr">
                    <a target="_blank" href="item.html" title="促销信息，下单即赠送三个月CIBN视频会员卡！【小米电视新品4A 58 火爆预约中】">{{goodItem.title}}</a>
                  </div>
                  <div class="commit">
                    <i class="command">已有<span>2000</span>人评价</i>
                  </div>
                  <div class="operate">
                    <a class="sui-btn btn-bordered btn-danger"@click="tips">加入购物车</a>
                    <a href="javascript:void(0);" class="sui-btn btn-bordered">收藏</a>
                  </div>
                </div>
              </li>
...
...mapGetters(["attrsList","goodsList","trademarkList"]),
    ...
    methods:{
      ...
      getAttrInfo(attrsItem,attrValue){
        let props=`${attrsItem.attrId}:${attrValue}:${attrsItem.attrName}`;
